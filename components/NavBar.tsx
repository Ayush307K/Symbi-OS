...
const LOCATION_PRESETS = [
  ...
  {
    label: "Mundra, Gujarat",
    query: "Mundra Gujarat India",
    detail: "Port-linked metal and polymer sell offers",
  },
  {
    label: "Mumbai, Maharashtra",
    query: "Mumbai Maharashtra India",
    detail: "Plastic, metal, and export-linked scrap offers",
  },
  {
    label: "Chennai, Tamil Nadu",
    query: "Chennai Tamil Nadu India",
    detail: "Polymer and industrial material offers",
  },
  {
    label: "Hyderabad, Telangana",
    query: "Hyderabad Telangana India",
    detail: "Seller-company location filtering",
  },
  {
    label: "Raipur, Chhattisgarh",
    query: "Raipur Chhattisgarh India",
    detail: "Metal and industrial scrap offers",
  },
  {
