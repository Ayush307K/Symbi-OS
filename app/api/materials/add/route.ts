  ...
  try {
    ...
    await prisma.marketplaceListing.create({
      data: {
        ...
        sourceName: "Symbi-OS seller listing",
        externalId: `seller:${listingId}`,
        rawQuantityText: quantity ? `${quantity.toLocaleString("en-IN")} ton` : null,
        rawLocationText: "Seller location",
        materialId: material.id,
